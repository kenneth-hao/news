...
(function () {
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, e = function (a, f) {
            ...
            table: 1,
            ul: 1
        }, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, g = {}, j = {"#": 1}, l = {
            center: 1,
            dir: 1,
            noframes: 1
        };
    ...
    (function () {
        ...
        CKEDITOR.dom.range.prototype =
        {
            ...
            return function (b) {
                ...
                return {
                    start: d.container.getAddress(b), end: c ? null : e.container.getAddress(b),
    ...
    (function () {
        ...
        function z(a, b, d, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                for (var m = a.elementCallbacks, p = 0, A = m.length, o; p < A; ++p)if (o = m[p](b)) {
                    i = o;
                    break;
                }
                if (i)return i
                    ...
                    for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.name == "body", s, k = d.length; k > 0;) {
                        ...
                        if (f && (r.type == CKEDITOR.NODE_TEXT || r.type == CKEDITOR.NODE_ELEMENT && F.$inline[r.name])) {
                            ...
                            s =
                                null;
                            r.insertAfter(a);
                            e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (r.type == CKEDITOR.NODE_ELEMENT && !F[e.name][r.name]) && c.push({
                                check: "el-up",
                                el: r
                            })
                        }
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, e) {
                ...
                var e = this, f = [], i = this.editor && this.editor.config.protectedSource, r, m = false, s = {
                    doFilter: !c,
                    doTransform: true,
                    doCallbacks: true,
                    toHtml: b
        ...
        var v = {styles: 1, attributes: 1, classes: 1}, C = {
            styles: "requiredStyles", attributes: "requiredAttributes",
            classes: "requiredClasses"
        }, A = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, E = {
            styles: /{([^}]+)}/,
            attrs: /\[([^\]]+)\]/,
            classes: /\(([^\)]+)\)/
        ...
        a.prototype = {
            add: function (a, c, e) {
                this.rules.splice(this.findIndex(c), 0, {value: a, priority: c, options: e})
                                  ...
                                  c, e) {
                for (var d = [this.findIndex(c), 0], g = 0, j = a.length; g < j; g++)d.push({
                    value: a[g],
                    priority: c,
                    options: e
                });
    ...
    (function () {
        ...
        var q = /(?:&nbsp;|\xa0)$/, x = "{cke_protected}", i = CKEDITOR.dtd, m = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], k = CKEDITOR.tools.extend({}, i.$blockLimit, i.$block), s = {
            elements: {
                input: j,
                textarea: j
            }
        }, u = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, p = {
            elements: {
                embed: function (a) {
                    var b = a.parent;
                    if (b && b.name == "object") {
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, d = a.element, e = a.elementMode,
                j = a.fire("uiSpace", {space: "top", html: ""}).html, l = a.fire("uiSpace", {
                    space: "bottom",
                    html: ""
                }).html, h = new CKEDITOR.template('<{outerEl} id="cke_{name}" class="{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir="{langDir}" lang="{langCode}" role="application"' + (a.title ? ' aria-labelledby="cke_{name}_arialbl"' : "") + ">" + (a.title ? '<span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span>' : "") + '<{outerEl} class="cke_inner cke_reset" role="presentation">{topHtml}<{outerEl} id="{contentId}" class="cke_contents cke_reset" role="presentation"></{outerEl}>{bottomHtml}</{outerEl}></{outerEl}>'),
    ...
    (function () {
        ...
        var z = function () {
            ...
            var h = CKEDITOR.dtd, g = {
                ...
                dl: 1,
                blockquote: 1
            }, p = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, l = CKEDITOR.tools.extend({}, h.$inline);
            delete l.br;
            return function (g, n, u) {
                ...
                if (!t.checkReadOnly()) {
                    var B = (new CKEDITOR.dom.elementPath(t.startContainer, t.root)).blockLimit || t.root, n = {
                        type: n,
                        dontFilter: w,
                        editable: g,
                        editor: o,
                        ...
                        mergeCandidates: [],
                        zombies: []
                    }, o = n.range, w = n.mergeCandidates, v, C, A, E;
    ...
    (function () {
        ...
        }, p =
        {
            ...
            audio: 1,
            video: 1
        }, O = /\s*(?:;\s*|$)/, S = /#\((.+?)\)/g, F = CKEDITOR.dom.walker.bookmark(0, 1), J = CKEDITOR.dom.walker.whitespaces(1);
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            getUiColor: function () {
                ...
                return (this.setUiColor = function (a) {
                    var c = CKEDITOR.skin.chameleon, d = [[l, a]];
                    this.uiColor = a;
                    f([b], c(this,
                        "editor"), d);
                    f(j, c(this, "panel"), d)
            ...
            if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
                var b = a.editor, a = function (a) {
                    ...
                    if (!a.getById("cke_ui_color")) {
                        ...
                        j.push(a);
                        var d = b.getUiColor();
                        d && f([a], CKEDITOR.skin.chameleon(b, "panel"), [[l, d]])
                    }
                };
                b.on("panelShow", a);
                b.on("menuShow", a);
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("undo", {
            init: function (a) {
                ...
                var c = a.undoManager = new k(a), e = c.editingHandler = new l(c), f = a.addCommand("undo", {
                    exec: function () {
        ...
        k.prototype = {
            keyGroupsEnum: {PRINTABLE: 0, FUNCTIONAL: 1},
            strokesRecorded: [0, 0],
            navigationKeyCodes: {37: 1, 38: 1, 39: 1, 40: 1, 36: 1, 35: 1, 33: 1, 34: 1},
            previousKeyGroup: -1,
            type: function (a) {
