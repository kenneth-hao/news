...
(function () {
    ...
    (function () {
        ...
        var w = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'], x = ['Node', "\x6d\x65\163\163\x61\x67\x65"];
        ...
        function B() {
            ...
            M.bh('RenderThumbnails', ['requestRenderThumbnails'], function aP(R) {
                ...
                var T = function (bV) {
                    ...
                    return eN;
                }, U = this.eh.$.offsetHeight, V = this.eh.$.scrollTop, W = T(this.eh.$), X = this.app.config.thumbnailDelay, Y = this.app.config.showContextMenuArrow ? 1 : 0;
            ...
            M.bh('RenderFiles', ['requestRenderFiles'], function eN(R) {
                var S = this.data(), T, U = R.data && (R.data.lookup || R.data.lastView && R.data.lastView.lookup), V = R.data && (!!R.data.ma || !!R.data.lK || !!U), W = R.data && R.data.ma, X;
                if (!O)return;
            ...
            M.bh('SelectFile', ['click', 'requestSelectFile'], function W(R) {
                var S = this.tools.bZ(R), T = R.name == 'click', U = R.data && R.data.multiple && this.app.config.selectMultiple;
            ...
            M.bh('ShowFolderFiles', ['requestShowFolderFiles'], function V(R) {
                var S = this, T = a.ld.bX['foldertree.foldertree'].tools.cq(R), U = k.extend({}, R.data, {folder: T}, true);
        ...
        function C(M, N, O, P, Q, R) {
            ...
            Y.sendCommandPost(aa, null, S, function ar(aT) {
                ...
                if (bm == Y.ERROR_COPY_FAILED || bm == Y.ERROR_MOVE_FAILED) {
                    Z = 1;
                    var eN = aT.selectNodes('Connector/Errors/Error'), gB = parseInt(aT.selectSingleNode('Connector/' + (O ? 'MoveFiles/@moved' : 'CopyFiles/@copied')).value, 10), dX = 0, gs = [], am, gP, gR, pw;
                    ...
                    dX && M.cg.openDialog('moveFileExists', function (as) {
                        ...
                        as.on('ok', function aB(av) {
                            av.removeListener();
                            var aw = as.getContentElement('tab1', 'option').getValue(), ax = as.getContentElement('tab1', 'remember').getValue(), ay;
                            switch (aw) {
                                case 'autorename':
                                case 'overwrite':
                                    ay = [aw];
    ...
    (function () {
        var r = "\074\x64\151\166\x20\x63\154\x61\163\x73\075\x27\166\151\145\x77\040\x74\157\157\x6c\x5f\160\141\156\145\x6c\047\x20\x73\x74\171\154\145\x3d\047\x70\141\144\144\x69\x6e\x67\x3a\062\x70\170\073\x64\151\163\x70\154\x61\x79\072\x62\x6c\x6f\143\x6b\x20\041\151\x6d\x70\x6f\x72\x74\141\156\164\x3b\x70\157\163\151\164\x69\157\x6e\x3a\x73\x74\141\x74\x69\x63\040\x21\151\155\x70\157\162\164\141\156\x74\x3b\143\157\x6c\x6f\x72\072\x62\x6c\x61\143\153\x20\x21\151\x6d\x70\157\x72\164\141\x6e\164\073\142\141\143\x6b\x67\x72\157\x75\x6e\144\055\143\157\x6c\x6f\162\x3a\x77\150\x69\x74\145\040\041\151\x6d\x70\x6f\162\x74\x61\x6e\x74\x3b\047\076", s = "\074\057\144\x69\166\x3e", t = r + "\x54\150\151\163\040\x69\163\040\164\150\145\x20\x44\105\115\x4f\040\x76\145\x72\x73\151\x6f\x6e\040\157\146\x20\103\x4b\x46\151\x6e\144\145\x72\056\040\120\x6c\x65\x61\x73\x65\040\x76\x69\163\x69\164\x20\164\150\x65\040\074\x61\040\x68\162\x65\x66\075\047\150\164\x74\160\x3a\x2f\x2f\143\153\x73\x6f\x75\x72\x63\145\x2e\143\x6f\155\x2f\143\153\146\151\x6e\x64\145\162\x27\x20\164\x61\x72\x67\x65\164\x3d\x27\137\142\154\x61\156\x6b\x27\x3e\x43\113\106\151\x6e\144\145\x72\040\167\x65\x62\x20\x73\151\x74\145\x3c\057\141\076\x20\164\x6f\x20\157\x62\x74\x61\151\x6e\040\141\040\x76\x61\x6c\151\x64\x20\x6c\151\x63\x65\x6e\163\x65\056" + s, u = r + "\103\x4b\x46\x69\x6e\x64\x65\162\040\x44\x65\x76\x65\154\157\160\x65\162\x20\x4c\151\143\x65\156\163\x65\074\142\162\x2f\076\114\x69\x63\x65\156\163\x65\144\x20\x74\x6f\072\x20";
